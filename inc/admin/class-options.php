...
class Options {
	...
	public function wpgc_settings() {
		...
		Container::make( 'theme_options', __( 'Gestsup Connector' ) )
		         ...
		         ->add_tab( __( 'GestSup Help', 'wp-gestsup-connector' ),
			         array(
				         Field::make( 'html', 'wpgc_gestsup_help', __( 'Help', 'wp-gestsup-connector' ) )
				              ->set_html(
					              '<h3>' . __( 'If You Enjoy this plugin... encourage me!', '' . __( 'If You Enjoy this plugin... encourage me!', 'wp-gestsup-connector' ) . '' ) . '</h3>
