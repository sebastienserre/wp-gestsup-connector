...
class thfo_gestsup {
    ...
    public function menu_html()
    {
        ...
        <div class="ads" style="background: white; width: 50%; padding: 10px"><p><?php _e('A Premium Version of this Plugin exists. It will do the same thing + creating the user in GestSUP if doesn\'t and then create the ticket','wp-gestsup-connector');?></p>
            <p><a href="https://www.thivinfo.com/en/downloads/wp-gestsup-connector-pro/"><?php _e('Download It!','wp-gestsup-connector'); ?></a></p>
        </div>
...
">
        ...
        <ul>
            <strong><li><?php _e('How-to add a form in my website to create a ticket?','wp-gestsup-connector')?></li></strong>
            <ul>
